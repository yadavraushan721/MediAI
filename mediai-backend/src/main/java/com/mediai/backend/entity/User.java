...
public class User implements UserDetails{
	 ...
	 * {@link GrantedAuthority} object, which is used for authorization
	 ...
	 *
	 * <p>
	 * In this application, the user's email address is used as
	 * the authentication username for login and security validation.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * Returning {@code true} means the account is valid
	 * and not expired.
	 * </p>
	 *
	 ...
	 * and the user is allowed to authenticate.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * Returning {@code true} means the user's password
	 * and authentication credentials are still valid.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * Returning {@code true} means the user account is active
	 * and allowed to access the application.
	 * </p>
	 *
